...
* `Flash Offset`	Distance away from the barrel end to spawn the flash VX, in UE units (cm).
* `Attached Flash` Whether to spawn the flash attached to the weapon or have it stay where it was spawned.
* `Looped Flash` If true, the flash VX will be manually deactivated when appropriate.
