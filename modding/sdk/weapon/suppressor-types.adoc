These are the suppressor socket names for suppressors of compatible calibers. There may be one or more suppressors that are able to connect to generic socket names:
