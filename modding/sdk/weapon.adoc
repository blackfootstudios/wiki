...
You will need to make sure you have properly link:/modding/sdk/weapon/setting-up-weapon-skeletal-mesh[set up your skeletal mesh], so that all the animation aspects will work properly. You may need to @add custom code to your weapon blueprint to handle custom behaviour for your specific weapon.
