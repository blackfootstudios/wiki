...
You will need to make sure that your skeletal mesh model is skinned properly. See link:/modding/sdk/weapon/skinning-weapon-models[skinning weapon models] for more details.
