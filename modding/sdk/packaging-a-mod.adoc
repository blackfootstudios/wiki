...
NOTE: The Mod Kit Package button will only attempt to cook and package your mods. The 'cook project' option and similar will try to cook and package everything in the Mod Kit, including the GBCore section. 
