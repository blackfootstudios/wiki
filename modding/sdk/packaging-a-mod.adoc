...
image::/images/packaging-a-mod/packaging-mod.png[Screenshot,60%]
...
image::/images/packaging-a-mod/packaged-mod.png[Screenshot,60%]
...
.Opening output log
image::/images/sdk/modkit_outputlog.jpg[Screenshot,60%]
